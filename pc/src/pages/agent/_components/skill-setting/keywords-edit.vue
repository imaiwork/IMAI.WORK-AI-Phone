<template>
    <popup
        ...
        <div>
            ...
            <div class="text-2xl font-medium mb-5">{{ formData.id ? "编辑" : "添加" }}关键词回复</div>
            <!-- 表单 -->
...
import { addRobotKeywords, updateRobotKeywords } from "@/api/agent";
import { type FormInstance } from "element-plus";
import Popup from "@/components/popup/index.vue";
import AddContent from "@/pages/app/person_wechat/_components/add-content.vue";
