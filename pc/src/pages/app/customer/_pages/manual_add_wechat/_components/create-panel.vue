<template>
    <div class="h-full bg-white rounded-[20px] flex flex-col w-[1000px] mx-auto">
        <!-- 头部导航 -->
        <div
            class="flex-shrink-0 flex items-center justify-between px-[14px] h-[88px] border-b border-[var(--el-border-color)]">
        ...
        <div class="grow min-h-0">
            <ElScrollbar>
                <div class="w-[456px] mx-auto mt-6">
                    <div class="text-[20px] font-bold">创建新的自动加好友任务</div>
                    <div class="mt-6 flex flex-col gap-y-3">
                        <div>
                            <div class="text-[#00000080] mb-3">任务名称</div>
                            <ElInput
                        ...
                        <div>
                            <div class="text-[#00000080] mb-3">线索来源</div>
                            <div>
                        ...
                        <template v-if="formData.source == 1">
                            <div>
                                <div class="flex items-center justify-between mb-3">
                                    <div class="text-[#00000080]">导入模版</div>
                                ...
                                <upload
                                    ...
                                    <div class="flex flex-col items-center justify-center py-6">
                                        <Icon name="local-icon-upload2" :size="48" color="#0000004d"></Icon>
                                        <div class="mt-3 text-[#0000004d]">点击添加或将文件拖拽到该处</div>
                                        <div class="text-xs text-[#00000033] mt-2 w-[80%]">
                                            支持扩展名：.csv、.xlsx格式
                                        </div>
                                    </div>
                                </upload>
                        ...
                        <template v-if="formData.source == 2">
                            <div>
                                <div class="text-[#00000080] mb-3">获客任务引用</div>
                                <ElSelect
                        ...
                        <div>
                            <div class="text-[#00000080] mb-3">执行设备</div>
                            <div>
                                <ElSelect
                        ...
                        <div>
                            <div class="text-[#00000080] mb-3">时间设置</div>
                            <div class="border border-[var(--el-border-color)] rounded-xl p-4">
                                <div>自动加好友设置</div>
                                <div class="mt-4">
                                        ...
                                        <div
                                            ...
                                            :class="[
                                                formData.task_frep == item && currentFrequency != 5
                                                    ...
                                                    : 'shadow-[0_0_0_1px_var(--el-border-color)] hover:bg-primary-light-9',
                                            ]"
                        ...
                        <div class="border border-[var(--el-border-color)] rounded-xl p-4 mt-4">
                            <div>自动加好友设置</div>
                            <div class="text-[#00000080] text-xs mt-2">
                                注意：开启此任务请确保当前网络是常用安全网络，加资账号为常态化老号
                            </div>
                            <div class="mt-4">
                                <div class="text-[#00000080] mb-3">加微微信：</div>
                                <ElSelect
                            ...
                            <div class="mt-2">
                                <div class="text-[#00000080] mb-3">加微规则：</div>
                                <ElSelect v-model="formData.wechat_reg_type" class="!h-11" :show-arrow="false">
                            ...
                            <div class="mt-2">
                                <div class="text-[#00000080] mb-3">自动加好友频率：</div>
                                <div class="flex items-center gap-x-4">
                                    <div class="flex-1">
                                        <div class="mb-3">当天执行</div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            ...
                                            <span class="text-[#00000080]">分钟</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div v-if="formData.add_remark_enable == 1">
                                    <div class="flex flex-wrap gap-2">
                                        <div
                                            ...
                                            :key="index"
                                            class="cursor-pointer hover:bg-primary-light-9 transition-all duration-300 border border-[var(--el-border-color)] rounded-md px-4 py-2 flex items-center"
                                            @click="handleEditRemark(item, index)">
                                            <div class="text-xs">{{ item }}</div>
                                            <div class="w-[1px] h-[8px] bg-[var(--el-border-color)] mx-2"></div>
