<template>
    <div class="live-pop-container w-[500px] relative">
        <svg
            ...
            <path d="M20 0 L20 20 C20 20 20 10 0 10 C10 10 20 5 20 0" fill="#ffffff" />
        </svg>
        <div class="rounded-3xl overflow-hidden ml-4">
            <div class="h-[365px] px-6 live-pop-cover">
            ...
            <div class="px-6 py-4 bg-white">
                ...
                <div class="text-xs text-[#00000080] mt-[10px]">
                ...
                <div class="flex gap-x-[10px] mt-6">
                    <ElPopover
                        ...
                        <div class="rounded-xl">
                            <img :src="appLiveConfig.recharge_entrance_qr_code" class="w-[152px] h-[152px]" />
                        </div>
                    </ElPopover>
...
const appLiveConfig = computed(() => appStore.getAppLiveConfig);

const downloadClient = () => {
    window.open(appLiveConfig.value.apk_url);
};
</script>
