<template>
    <div
        ...
        <div class="relative w-full h-full" v-if="formData.reply">
            <div ref="toolbarContainer"></div>
            <div ref="mindMapContainerWrapper" class="w-full h-full">
...
const mindMapContainerWrapper = shallowRef<HTMLElement | null>(null);
...
const handleExport = () => {
    mindMapExportAsPNG(mindMapContainerWrapper.value);
};
