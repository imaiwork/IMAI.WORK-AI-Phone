<template>
    <div class="survey-dialog">
        <ElDialog v-model="showSurvey" width="730" top="10vh" :show-close="false" :append-to-body="false">
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-10">
                        <div class="flex items-center gap-4">
                            <div class="text-[32px] font-medium">欢迎使用</div>
                ...
                <div class="mt-10">
                    <div class="mt-4">
                        <div class="text-[18px] font-medium">贵公司的规模有多大？</div>
                        <div class="mt-4">
                            <ElRadioGroup v-model="formData.company_size" size="large">
                    ...
                    <div class="mt-8">
                        <div class="text-[18px] font-medium">贵公司的名称：</div>
                        <div class="mt-4">
                            <ElInput v-model="formData.company_name" class="!h-[48px]" placeholder="请输入贵公司名称" />
                        </div>
                    </div>
                </div>
                <div class="mt-8 flex justify-center">
                    <ElButton type="primary" class="w-[336px] !h-[48px] mx-auto" :loading="isLock" @click="lockFn">
                        确认提交
                    </ElButton>
                </div>
            </div>
