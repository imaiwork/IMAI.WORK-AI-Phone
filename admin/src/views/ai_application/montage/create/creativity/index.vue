    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4 flex justify-between">
                <el-button
                    v-perms="['ai_application.montage.create.creativity/delete']"
                    type="default"
                    :plain="true"
            ...
            <el-table
                ...
                <el-table-column label="素材组数" prop="image_count" width="100" />
                <el-table-column label="创作数量" prop="video_count" width="100" />
                <el-table-column label="创作内容" prop="copywriting" min-width="180" show-overflow-tooltip />
                ...
                <el-table-column label="操作" width="120" fixed="right">
                    <template #default="{ row }">
                        <el-button v-perms="['ai_application.montage.create.creativity/detail']" type="primary" link>
                            <router-link
                                :to="{
                                    path: getRoutePath('ai_application.montage.create.creativity/detail'),
                                    query: {
                                        id: row.id,
                                        name: row.name,
                                    },
...
import { getMontageSoraTaskList, deleteMontageSoraTask } from "@/api/ai_application/digital_human/montage";
...
const { pager, getLists, resetPage, resetParams } = usePaging({
    fetchFun: getMontageSoraTaskList,
    params: queryParams,
});
...
const handleDelete = async (id: number | number[]) => {
    ...
    await deleteMontageSoraTask({ id });
    getLists();
