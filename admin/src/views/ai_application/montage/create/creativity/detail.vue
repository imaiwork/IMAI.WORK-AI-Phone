    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4 flex justify-between">
                <el-button
                    v-perms="['ai_application.montage.create.material.detail/delete']"
                    type="default"
                    :plain="true"
            ...
            <el-table
                ...
                <el-table-column label="参考素材" prop="name" min-width="180">
                    <template #default="{ row }">
                        <div class="grid grid-cols-4 gap-2">
                            <div v-for="item in row.extra?.image_urls" class="w-[60px] h-[60px]">
                                <image-contain
                                    :src="item"
                                    width="60"
                                    height="60"
                ...
                <el-table-column label="创作提示词" prop="msg" min-width="180" show-overflow-tooltip />
...
import { getMontageSoraTaskRecord, deleteMontageSoraTaskDetail } from "@/api/ai_application/digital_human/montage";
...
const { pager, getLists, resetPage, resetParams } = usePaging({
    fetchFun: getMontageSoraTaskRecord,
    params: queryParams,
});
...
const handleDelete = async (id: number | number[]) => {
    ...
    await deleteMontageSoraTaskDetail({ id });
    getLists();
