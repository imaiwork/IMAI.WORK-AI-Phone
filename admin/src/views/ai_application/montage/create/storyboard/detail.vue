    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4 flex justify-between">
                <el-button
                    v-perms="['ai_application.montage.create.storyboard.detail/delete']"
                    type="default"
                    :plain="true"
...
import {
    getMontageStoryboardRecordDetailList,
    deleteMontageStoryboardRecord,
...
const { pager, getLists, resetPage, resetParams } = usePaging({
    fetchFun: getMontageStoryboardRecordDetailList,
    params: queryParams,
});
