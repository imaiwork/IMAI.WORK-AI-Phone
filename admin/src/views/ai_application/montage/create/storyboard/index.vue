    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4 flex justify-between">
                <el-button
                    v-perms="['ai_application.montage.create.storyboard/delete']"
                    type="default"
                    :plain="true"
            ...
            <el-table
                ...
                <el-table-column label="操作" width="120" fixed="right">
                    <template #default="{ row }">
                        <el-button v-perms="['ai_application.montage.create.storyboard/detail']" type="primary" link>
                            <router-link
                                :to="{
                                    path: getRoutePath('ai_application.montage.create.storyboard/detail'),
                                    query: {
                                        id: row.id,
                                        name: row.name,
                                    },
...
import { getMontageStoryboardRecord, deleteMontageStoryboardRecord } from "@/api/ai_application/digital_human/montage";
...
const { pager, getLists, resetPage, resetParams } = usePaging({
    fetchFun: getMontageStoryboardRecord,
    params: queryParams,
});
...
const handleDelete = async (id: number | number[]) => {
    ...
    await deleteMontageStoryboardRecord({ id });
    getLists();
