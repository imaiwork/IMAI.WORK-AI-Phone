<template>
    <div>
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="创作类型">
                    <el-select v-model="queryParams.type" class="!w-[160px]" placeholder="请选择创作类型" clearable>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div class="mb-4 flex justify-between">
                <el-button
                    v-perms="['ai_application.draw_video.record/delete']"
                    type="default"
                    :plain="true"
    ...
    <detail-pop ref="detailPopRef" v-if="showDetailPop" @close="showDetailPop = false"></detail-pop>
</template>
<script lang="ts" setup>
import { getDrawRecordVideoList, delDrawRecordVideo } from "@/api/ai_application/draw/draw_records";
