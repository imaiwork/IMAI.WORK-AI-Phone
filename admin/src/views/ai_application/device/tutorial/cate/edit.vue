...
import { addTutorialCategory, editTutorialCategory } from "@/api/ai_application/device/tutorial";
...
const handleSubmit = async () => {
    ...
    mode.value == "edit" ? await editTutorialCategory(formData) : await addTutorialCategory(formData);
