<template>
    <div>
        <el-card class="!border-none" shadow="never">
            <el-page-header :content="route.query.name || '应用详情'" @back="$router.back()" />
        </el-card>
        <el-card class="!border-none mt-4" shadow="never">
            <el-form class="ls-form" ref="formRef" :rules="rules" :model="formData" label-width="90px">
                ...
                <el-form-item label="应用标签" prop="tips">
                    <div class="flex items-center gap-2 justify-between w-[300px]">
                        <el-input
                            class="flex-1"
                            v-model="tags[0]"
                ...
                <el-form-item label="是否标新" prop="is_new">
                    <el-switch v-model="formData.is_new" :active-value="1" :inactive-value="0" />
                </el-form-item>
                <el-form-item label="状态" prop="show_status">
                    <el-switch v-model="formData.show_status" :active-value="1" :inactive-value="0" />
                </el-form-item>
            </el-form>
        </el-card>
...
import { getApplicationDetail, editApplication } from "@/api/decoration/application";
