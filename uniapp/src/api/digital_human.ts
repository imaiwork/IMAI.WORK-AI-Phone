...
export const generateShanjianPrompt = (data: Record<string, any>) => {
    return request.post(
        { url: '/shanjian.shanjianVideoTask/copywriting', data },
        { ignoreCancel: true }
    )
}
...
// 闪剪风格模板列表
export const getShanjianClipTemplateList = (data: Record<string, any>) => {
    return request.get({ url: '/shanjian.shanjianClipTemplate/lists', data })
}
...
// 闪剪成片重新下载/转存
export const downloadShanjianVideoTask = (data: { id: number }) => {
    return request.post({ url: '/shanjian.shanjianVideoTask/download', data })
}
...
// minimax 音频上传
export const minimaxAudioUpload = (data: Record<string, any>) => {
    return request.post({ url: '/minimax.voice/upload', data })
}

// minimax 音频克隆
export const minimaxVoiceClone = (data: Record<string, any>) => {
    return request.post({ url: '/minimax.voice/add', data })
}
