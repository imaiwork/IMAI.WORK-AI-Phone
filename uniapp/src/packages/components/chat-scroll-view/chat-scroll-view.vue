<template>
    <view class="h-full flex flex-col min-h-0">
        <view class="flex flex-col flex-1 min-h-0 py-4 relative" v-if="contentList.length" @tap="hideKeyboard">
        ...
        <view class="grow min-h-0 relative" v-else @tap="hideKeyboard">
                    ...
                    <scroll-view v-if="!isCoze && !isStaff && spacerHeight == 0" scroll-x class="mb-1">
                        <view class="flex items-center gap-x-2 whitespace-nowrap pt-1">
                            <template v-if="!isAgent">
                                ...
                                <view
                                    v-if="!currAgent.id && !isPhoneCtrlActive"
                                    :class="
                                        isHome
                                ...
                                <u-icon
                                    ...
                                    :name="
                                        isHome
                                            ...
                                            : '/static/images/icons/deep_white.svg'
                                    "
                                    :size="24"></u-icon>
                                <text v-if="!isHome" class="text-xs">联网</text>
                            </view>
                            <view
                            ...
                            <view
                                v-if="!isAgent && !isPhoneCtrlActive"
                                :class="
                                    isHome
                                        ? tbMini(false)
                    ...
                    <view class="flex-1 flex gap-x-2 items-center">
                        ...
                        <view
                            ...
                            <view class="flex items-center pl-2 py-[12rpx]">
                                <view v-if="!isCoze && !isStaff && !isPhoneCtrlActive" class="flex-shrink-0">
                                    <view
    ...
    <mount-popup
        v-if="isHome && showMount"
        v-model="showMount"
        :mounted-ids="mountedIds"
...
import MountPopup from "./components/mount-popup.vue";
