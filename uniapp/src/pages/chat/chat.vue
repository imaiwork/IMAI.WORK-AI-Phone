<template>
    <view class="h-screen flex flex-col bg-[#EEF0F6]">
        ...
        <view v-if="chatContentList.length == 0 && currType === 0" class="fixed top-[150rpx] left-0 w-full z-[1]">
            <empty-content :curr-agent="currAgent" :curr-model="currModel" @select-model="handleSelectModel" />
        </view>
        <view class="grow min-h-0 relative z-10 pt-2">
            ...
            <view class="h-full w-full flex flex-col" v-show="currType === 2">
