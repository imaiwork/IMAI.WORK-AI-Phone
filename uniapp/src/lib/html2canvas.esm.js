...
const DocumentCloner = /** @class */ (function () {
    ...
    DocumentCloner.prototype.toIFrame = function (ownerDocument, windowSize) {
         ...
         */
        const iframeLoad = iframeLoader(iframe).then(function () {
            return __awaiter(_this, void 0, void 0, function () {
                let onclone, referenceElement
    ...
    DocumentCloner.prototype.cloneNode = function (node, copyStyles) {
        ...
        if (window && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
            ...
            const counters = this.counters.parse(
                new CSSParsedCounterDeclaration(this.context, style)
            )
            const before = this.resolvePseudoContent(
                node,
                clone,
                styleBefore,
            ...
            const after = this.resolvePseudoContent(
                node,
                clone,
                styleAfter,
...
const isBezierCurve = function (path) {
...
const BoundCurves = /** @class */ (function () {
    function BoundCurves(element) {
        ...
        let _c = getAbsoluteValueForTuple(
            ...
            brh = _c[0],
            brv = _c[1]
        let _d = getAbsoluteValueForTuple(
...
const OpacityEffect = /** @class */ (function () {
...
const isClipEffect = function (effect) {
    return effect.type === 1 /* CLIP */
}
const isOpacityEffect = function (effect) {
...
const parsePathForBorderDoubleOuter = function (curves, borderSide) {
    switch (borderSide) {
        case 0:
            return createPathFromCurves(
                curves.topLeftBorderBox,
...
const parsePathForBorderDoubleInner = function (curves, borderSide) {
    switch (borderSide) {
        case 0:
            return createPathFromCurves(
...
const parsePathForBorderStroke = function (curves, borderSide) {
    switch (borderSide) {
        case 0:
...
const calculateBackgroundRendering = function (container, index, intrinsicSize) {
    ...
    const sizeWidth = backgroundImageSize[0],
...
const isAuto = function (token) {
    return isIdentToken(token) && token.value === BACKGROUND_SIZE.AUTO
}
const hasIntrinsicValue = function (value) {
    return typeof value === 'number'
}
var calculateBackgroundSize = function (size, _a, bounds) {
    const intrinsicWidth = _a[0],
...
const CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.renderTextNode = function (text, styles) {
        return __awaiter(this, void 0, void 0, function () {
            let _a, font, fontFamily, fontSize, _b, baseline, middle, paintOrder
            const _this = this
    ...
    CanvasRenderer.prototype.renderBackgroundImage = function (container) {
        return __awaiter(this, void 0, void 0, function () {
            let index, _loop_1, this_1, _i, _a, backgroundImage
...
const ForeignObjectRenderer = /** @class */ (function (_super) {
...
var renderElement = function (element, opts) {
    return __awaiter(void 0, void 0, void 0, function () {
        var ownerDocument,
            ...
            root,
            renderer
        let _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t
