<template>
    <view class="">
        <view
            ...
            :style="[navbarStyle]"
            :class="{
                'u-navbar-fixed': isFixed,
                'u-border-bottom': borderBottom,
            }">
            <view class="u-status-bar" :style="{ height: statusBarHeight + 'px' }"></view>
            <view class="u-navbar-inner" :style="[navbarInnerStyle]">
                <view class="u-back-wrap" v-if="isBack" @tap="goBack">
                    <view class="u-icon-wrap" :style="{ borderRadius: '50%', padding: '8rpx' }">
                        <u-icon
                            :name="isHome ? 'home' : backIconName"
                            :color="backIconColor"
                            :size="backIconSize"
                            v-if="!isCustomBackIcon"></u-icon>
                        <slot v-else name="custom-back-icon"></slot>
                    </view>
