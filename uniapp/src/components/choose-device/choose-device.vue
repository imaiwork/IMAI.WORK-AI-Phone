        ...
        <template #content>
            <view class="h-full flex flex-col">
                <view class="flex items-center justify-between px-[30rpx] mt-3 mb-1" v-if="limit > 1">
                    <text class="text-[26rpx] text-[#666666] font-medium">请选择设备</text>
                    <view class="text-[24rpx] text-[#999999]">
                        已选 <text class="text-[#0065fb] font-bold mx-0.5">{{ chooseLists.length }}</text> / {{ limit }}
                    </view>
                </view>
                        ...
                        <view class="px-[30rpx] py-4 flex flex-col gap-y-3.5">
                            <view
                                ...
                                <view class="flex-1 min-w-0">
                                    ...
                                    <text class="text-[24rpx] text-[#999999]">扫码或输入设备码快速绑定</text>
                                </view>
                            ...
                            <view
                                ...
                                <view class="flex items-center gap-x-3">
                                    ...
                                    <view class="flex-1 min-w-0">
                                        ...
                                        <text
                                            class="text-[24rpx] truncate block"
                                ...
                                <view v-if="item.accounts?.length" class="flex items-center">
                                    <view class="flex items-center">
                                        <view
                                            ...
                                            :style="{ marginLeft: accIdx > 0 ? '-16rpx' : '0', zIndex: 5 - accIdx }">
