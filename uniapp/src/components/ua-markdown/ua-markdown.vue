            ...
            <view v-else-if="block.type === 'code'" class="code-block">
                <view class="code-block__header">
                    ...
                    <view class="code-block__copy" @tap.stop="copyCode(block.raw)">
                        <text class="code-block__copy-text">{{ copiedIndex === index ? "已复制 ✓" : "复制" }}</text>
                    </view>
                </view>
                <scroll-view scroll-x class="code-block__scroll">
                    <mp-html :selectable="true" :content="block.content" :copy-link="false" :tag-style="codeTagStyle" />
                </scroll-view>
            </view>
        </template>
    </view>
