    ...
    <view class="h-screen flex flex-col device-bg">
        ...
        <view class="grow min-h-0">
            ...
            <view class="h-full flex flex-col" v-show="step === 2">
                ...
                <view class="px-4">
                    <view class="flex items-center justify-between gap-x-2" v-if="copywriterTypeIndex === 0">
                        <view
                    ...
                    <view class="flex items-center justify-between" v-if="copywriterTypeIndex === 1">
                        <view class="flex-1">
                        ...
                        <view
                            class="w-[190rpx] h-[70rpx] flex items-center justify-center gap-x-2 bg-black rounded-[100rpx]"
                            @click="showChooseAgent = true">
                            <image src="/static/images/common/magic_white.png" class="w-[32rpx] h-[32rpx]"></image>
                            <text class="text-white font-medium text-[32rpx]">AI生成</text>
                        </view>
                                ...
                                <view
                                    ...
                                    <view class="mt-3 space-y-2" v-if="item.contentList.length > 0">
                                        <view
                                            ...
                                            :key="contentIndex"
                                            class="bg-[#F1F2F5] rounded-[16rpx] px-4 py-3 relative pr-8 font-medium"
                                    ...
                                    <view v-else class="text-xs text-[#000000]/50 text-center py-4"
                                        >点击左上角<u-icon name="plus" size="16" color="#0065fb"></u-icon
                                        ><text class="font-medium text-primary"> 添加 </text>按钮字幕内容</view
                                    >
                                </view>
                            </template>
                        </view>
