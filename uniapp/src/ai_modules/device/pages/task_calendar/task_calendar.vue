<template>
    <view class="px-[26rpx] pt-4" v-if="!loading">
        <view class="bg-white rounded-[30rpx] p-[30rpx] flex items-center gap-x-2 mb-[34rpx]" v-if="detail.device_name">
        ...
        <view class="bg-white rounded-[30rpx] px-[30rpx] pt-[20rpx] pb-[30rpx]">
            <calendar-simple v-model="selectedDate" :device-code="deviceCode" @change="reset" />
