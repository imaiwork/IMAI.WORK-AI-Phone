...
*/
;(function (factory) {
    const browser = typeof window == 'object' && !!window.document
    const win = browser ? window : Object //非浏览器环境，Recorder挂载在Object下面
    factory(win.Recorder, browser)
})(function (Recorder, isBrowser) {
    'use strict'
    const i18n = Recorder.i18n
    ...
    const putSet = { lang: 'your-language' }

    //@@Exec i18n.data["rtl$your-language"]=false;
    i18n.data['desc-page-Recorder_UniCore$your-language'] =
        'This file is a language translation template file. After copying and renaming, translate the text into the corresponding language. 此文件为语言翻译模板文件，复制并改名后，将文本翻译成对应语言即可。'
