...
;(function (factory) {
    ...
    const putSet = { lang: 'en' }

    //@@Exec i18n.data["rtl$en"]=false;
    i18n.data['desc-page-Recorder_UniCore$en'] =
        'English, 英语。This translation mainly comes from: google translation + Baidu translation, translated from Chinese to English. 此翻译主要来自：google翻译+百度翻译，由中文翻译成英文。'
