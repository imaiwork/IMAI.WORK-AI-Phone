    ...
    <view class="px-3">
        <view v-if="type === 1" class="flex">
            <view class="flex flex-col gap-2 items-end mt-1">
                ...
                <template v-else>
                    ...
                    <view class="bg-primary rounded-[32rpx] rounded-tr-none px-4 py-3" v-if="content">
        ...
        <view class="flex gap-2" v-if="type === 2">
            <view class="flex-shrink-0 mt-1">
                <view class="w-[64rpx] h-[64rpx] flex items-center justify-center">
                    <image :src="logo" class="w-full h-full rounded-full shadow shadow-light" mode="aspectFill"></image>
                </view>
            </view>
