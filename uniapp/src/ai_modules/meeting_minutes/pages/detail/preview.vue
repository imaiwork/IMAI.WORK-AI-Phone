        ...
        <view class="px-4">
            <view class="bg-white rounded-[24rpx] p-4">
                <view class="flex items-center gap-2">
                    ...
                    <view class="text-xl text-black font-medium"> 全文概要 </view>
                </view>
                <view class="mt-4">
            ...
            <view class="bg-white rounded-[24rpx] p-4 mt-4">
                <view class="flex items-center gap-2">
                    <image
                        src="@/ai_modules/meeting_minutes/static/images/common/loader.png"
                        class="w-[48rpx] h-[48rpx]"></image>
                    <view class="text-xl text-black font-medium"> 章节速览 </view>
                </view>
                <view class="mt-4">
                    <template v-if="getSections">
                        <u-read-more
                            ...
                            <view class="flex flex-col gap-4">
                                <view v-for="(item, index) in getSections" :key="index" class="flex gap-4">
                                    <view class="pt-[18rpx] relative">
                                        <view class="w-[16rpx] h-[16rpx] rounded-full bg-primary"></view>
                                        <view
                                            class="absolute h-full border border-dashed border-[#89899C] left-[6rpx] top-5"></view>
                                    </view>
                                    <view>
                                        <view class="flex gap-2">
                                            <text class="flex-shrink-0">{{ formatAudioTime(item.Start / 1000) }}</text>
                                            <text>{{ item.Headline }} </text>
                                        </view>
                                        <view class="bg-[#E8F0FF] p-2 rounded mt-2">
                                            <text class="text-xs text-[#63647C]">
                                                {{ item.Summary }}
                                            </text>
                                        </view>
                                    </view>
            ...
            <view class="bg-white rounded-[24rpx] p-4 mt-4">
                <view class="flex items-center gap-2">
                    <image
                        src="@/ai_modules/meeting_minutes/static/images/common/loader.png"
                        class="w-[48rpx] h-[48rpx]"></image>
                    <view class="text-xl text-black font-medium"> 问答回顾 </view>
                </view>
                <view class="mt-4">
                    <template v-if="getQa">
                        <u-read-more
                                ...
                                <view
                                    ...
                                    <view class="flex gap-4">
                                        <view class="flex-shrink-0 mt-1">
                                            <view class="flex items-center bg-white rounded-[24rpx]">
                                                <text class="text-primary font-medium mx-2">Q:</text>
                                            </view>
                                        </view>
                                        <view class="font-medium text-[#000000]">
                                            {{ item.Question }}
                                        </view>
                                    </view>
                                    <view class="flex gap-4 mt-3">
                                        <view class="flex-shrink-0 mt-1">
                                            <view class="flex items-center bg-white rounded-[24rpx]">
                                                <text class="text-[#FF8D1A] font-medium mx-2">A:</text>
                                            </view>
                                        </view>
            ...
            <view class="bg-white rounded-[24rpx] p-4 mt-4">
                <view class="flex items-center gap-2">
                    <image
                        src="@/ai_modules/meeting_minutes/static/images/common/loader.png"
                        class="w-[48rpx] h-[48rpx]"></image>
                    <view class="text-xl text-black font-medium"> 发言总结 </view>
                </view>
                <view class="mt-4">
                            ...
                            <view class="flex flex-col gap-4">
                                <view
                                    ...
                                    <view class="flex items-center gap-4">
                                        ...
                                        <text class="text-[#7F7F94]">{{ item.SpeakerName }}</text>
                                    </view>
            ...
            <view class="bg-white rounded-[24rpx] p-4 mt-4">
                <view class="flex items-center gap-2">
                    <image
                        src="@/ai_modules/meeting_minutes/static/images/common/loader.png"
                        class="w-[48rpx] h-[48rpx]"></image>
                    <view class="text-xl text-black font-medium"> 关键词 </view>
                </view>
                <view class="mt-4">
