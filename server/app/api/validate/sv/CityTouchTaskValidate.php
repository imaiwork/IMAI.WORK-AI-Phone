...
/**
 * 同城视频截流设置校验
 * Class CityTouchTaskValidate
 * @package app\api\validate\sv
 */
class CityTouchTaskValidate extends BaseValidate
{
    ...
    protected $message = [
        'id.require'              => '请输入主键ID',
        'task_type.require'       => '请输入同城视频截流任务类型：1评论、2私信',
        'name.require'            => '请输入同城视频截流任务名称',
        'accounts.require'        => '请选择账号',
        'task_start_time.require' => '请输入同城视频截流开始时间',
        'task_end_time.require'   => '请输入同城视频截流结束时间',
