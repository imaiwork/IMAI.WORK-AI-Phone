...
class AgentConfigLogic extends ApiLogic
{
     ...
     * @return bool
     */
    public static function updateCustomerService(array $params, int $userId): bool
    {
        Db::startTrans();
        try {
            ...
            $agentConfig = self::getCustomerServiceConfig($personaId, $userId, $configId);
    ...
    public static function detail(int $personaId, int $userId): bool
    {
        try {
            ...
            //     'comment_type'           => $agentConfig->comment_type,
            //     'comment_speech'         => $agentConfig->comment_speech,
    ...
    private static function getCustomerServiceConfig(int $personaId, int $userId, int $configId): AiPersonaAgentConfig
    {
        if ($configId > 0) {
            $agentConfig = AiPersonaAgentConfig::where([
                'id' => $configId,
