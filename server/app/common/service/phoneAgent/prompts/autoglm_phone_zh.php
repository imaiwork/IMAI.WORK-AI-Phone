...
其中：
- {think} 是对你为什么选择这个操作的简短推理说明，必须使用简体中文。
...
19. 所有自然语言输出（包括 thinking 推理、操作说明、finish message）必须使用简体中文，禁止输出英文句子；do(action=...) / finish(message=...) 的指令语法保持不变，Type/Launch 等动作里的文本内容按任务需要填写。
PROMPT;
