 ...
 * @author dagouzi
 */
class EnterpriseVideoSynthesis extends Command
{
    protected function configure()
    {
        $this->setName('enterprise_video_synthesis')
            ->setDescription('企业自动合成设备视频任务');
    }
    ...
    protected function execute(Input $input, Output $output)
    {
        try {
            ...
            Log::channel('ipVideoSynthesis')->write('企业自动合成设备视频任务');
