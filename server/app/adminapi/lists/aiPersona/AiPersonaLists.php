 ...
 * AI人设列表
 */
class AiPersonaLists extends BaseAdminDataLists implements ListsSearchInterface
{
    /**
     * @return array
     */
    ...
    public function where(): array
    {
        ...
        // 人设名称筛选（模糊匹配）
        if (isset($this->params['persona_name']) && $this->params['persona_name'] !== '') {
            $where[] = ['ap.persona_name', 'like', '%'.$this->params['persona_name'].'%'];
        }
        ...
        if (isset($this->params['keyword']) && $this->params['keyword'] !== ''){
            ...
            $where[] = !empty($user) ? ['ap.user_id', 'in', $user] : ['ap.user_id', '=', 0];
        }
    ...
    public function lists(): array
    {
        ...
        foreach ($lists as &$item) {
            ...
            // 查询AI人设有多少素材
            $item['material_num'] = Material::where('persona_id', $item['id'])->where('delete_time', null)->count();
