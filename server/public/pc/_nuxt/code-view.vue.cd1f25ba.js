import{_ as x}from"./index.vue.87ce5496.js";import{_ as b}from"./index.vue.8ae77c6b.js";import{d as g,A as j,aF as k,c as o,bK as y,k as C,I as $,s as B,m as t,q as n,Z as l,cV as D}from"./entry.062f432e.js";const V=g({__name:"code-view",emits:["close"],setup(F,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
