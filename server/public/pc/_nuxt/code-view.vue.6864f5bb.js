import{_ as x}from"./index.vue.3f013733.js";import{_ as b}from"./index.vue.030f2d17.js";import{d as g,A as j,aG as k,c as o,bK as y,k as C,I as $,s as B,m as t,q as n,Z as l,cX as D}from"./entry.8705b591.js";const V=g({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
