import{_ as d}from"./index.vue.0236e368.js";import{_ as $}from"./index.vue.196ac167.js";import{d as f,z as T,aJ as C,c as R,bK as O,k as P,B as k,s as x,m as e,q as s,I as y}from"./entry.91951d64.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(E,{expose:n,emit:r}){const p=r,o=T(),t=C({apikey:""});R(()=>`${location.origin}/chat/${t.apikey}`);const l=`
【接口地址】
请求方式: POST
