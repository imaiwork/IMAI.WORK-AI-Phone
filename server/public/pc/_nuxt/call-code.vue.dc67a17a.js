import{_ as d}from"./index.vue.00e91f2e.js";import{_ as $}from"./index.vue.799c3a6d.js";import{d as f,bM as T,k as C,A as R,s as O,m as e,q as s,H as P,aL as x,I as L}from"./entry.453cfaf0.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(k,{expose:n,emit:r}){const p=r,t=P(),o=x({apikey:""}),l=`
【接口地址】
请求方式: POST
