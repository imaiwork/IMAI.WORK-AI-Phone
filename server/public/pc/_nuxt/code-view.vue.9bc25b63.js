import{_ as x}from"./index.vue.6fee9a70.js";import{_ as b}from"./index.vue.fa705e81.js";import{d as g,z as j,aJ as k,c as o,bK as y,k as C,B as $,s as B,m as t,q as n,C as l,H as D}from"./entry.132af48d.js";const z=g({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
