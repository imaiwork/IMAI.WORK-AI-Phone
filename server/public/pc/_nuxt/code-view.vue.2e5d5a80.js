import{_ as x}from"./index.vue.d3989c6f.js";import{_ as b}from"./index.vue.9426281d.js";import{d as g,z as j,aI as k,c as o,bJ as y,k as C,A as $,s as B,m as t,q as n,B as l,E as D}from"./entry.f9749e08.js";const z=g({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
