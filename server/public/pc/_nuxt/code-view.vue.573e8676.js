import{_ as x}from"./index.vue.b0bee99e.js";import{_ as g}from"./index.vue.9e6bbe24.js";import{d as b,bM as j,k,A as y,s as C,m as e,q as o,B as l,H as $,e as n,I as B,aL as D}from"./entry.b08dce16.js";const L=b({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=$(),a=D({apikey:""}),i=n(()=>`${location.origin}/chat/${a.apikey}`),f=n(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
