import{_ as x}from"./index.vue.7532ad38.js";import{_ as b}from"./index.vue.e160aaa1.js";import{d as g,z as j,aJ as k,c as o,bK as y,k as C,B as $,s as B,m as t,q as n,C as l,I as D}from"./entry.f41a9673.js";const z=g({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
