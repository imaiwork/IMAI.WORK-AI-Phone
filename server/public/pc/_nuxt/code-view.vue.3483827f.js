import{_ as x}from"./index.vue.518df08e.js";import{_ as g}from"./index.vue.7ffd8af9.js";import{d as b,bM as j,k,A as y,s as C,m as e,q as o,B as l,H as $,e as n,I as B,aL as D}from"./entry.1d1ad599.js";const L=b({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=$(),a=D({apikey:""}),i=n(()=>`${location.origin}/chat/${a.apikey}`),f=n(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
