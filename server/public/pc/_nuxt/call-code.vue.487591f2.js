import{_ as d}from"./index.vue.518df08e.js";import{_ as $}from"./index.vue.7ffd8af9.js";import{d as f,bM as T,k as C,A as R,s as O,m as e,q as s,H as P,aL as x,I as L}from"./entry.1d1ad599.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(k,{expose:n,emit:r}){const p=r,t=P(),o=x({apikey:""}),l=`
【接口地址】
请求方式: POST
