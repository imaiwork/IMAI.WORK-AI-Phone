import{_ as x}from"./index.vue.b03112ed.js";import{_ as g}from"./index.vue.50ae4fa4.js";import{e as b,cw as j,o as k,s as y,w as C,a as e,b as o,k as l,ag as $,x as n,O as B,L as D}from"./entry.82b512ca.js";const L=b({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=$(),a=D({apikey:""}),i=n(()=>`${location.origin}/chat/${a.apikey}`),f=n(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
