import{_ as x}from"./index.vue.607f7609.js";import{_ as b}from"./index.vue.f5a0d8b1.js";import{d as g,z as j,aI as k,c as o,bJ as y,k as C,A as $,s as B,m as t,q as n,B as l,E as D}from"./entry.cd2e2670.js";const z=g({__name:"code-view",emits:["close"],setup(E,{expose:m,emit:p}){const d=p,s=j(),a=k({apikey:""}),i=o(()=>`${location.origin}/chat/${a.apikey}`),f=o(()=>`\`\`\`html
<iframe 
    src="${i.value}" 
    class="chat-iframe"
    frameborder="0"
