import{_ as d}from"./index.vue.3f013733.js";import{_ as $}from"./index.vue.030f2d17.js";import{d as f,A as T,aG as C,c as R,bK as O,k as P,I as k,s as x,m as e,q as s,cX as y}from"./entry.8705b591.js";const S=f({__name:"call-code",props:{showChatType:{type:[Boolean,Number]}},emits:["close"],setup(E,{expose:n,emit:r}){const p=r,o=T(),t=C({apikey:""});R(()=>`${location.origin}/chat/${t.apikey}`);const l=`
【接口地址】
请求方式: POST
